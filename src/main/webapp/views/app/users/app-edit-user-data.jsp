    ...
    <div class="row dashboard-nowrap">
        ...
        <div class="m-4 p-3 width-medium text-color-darker">
            <div class="m-4 border-dashed view-height">
                ...
                <form action="/app/user/data" method="POST">
                    <div class="mt-4 ml-4 mr-4">
                        ...
                        <table class="table borderless">
                            ...
                            <tr class="d-flex">
                                ...
                                <td class="col-7">
                                    <input class="w-100 p-1" name= "firstName" value="${admin.getFirst_name()}">
                                </td>
                            </tr>
                            <tr class="d-flex">
                                <th scope="row" class="col-2"><h4>Nazwisko</h4></th>
                                <td class="col-7">
                                    <input class="w-100 p-1" name="lastName" value="${admin.getLast_name()}">
                                </td>
                            </tr>
                            <tr class="d-flex">
                                <th scope="row" class="col-2"><h4>Email</h4></th>
                                <td class="col-3">
                                    <input class="p-1 w-100" name="email" type="text" value="${admin.getEmail()}">
                                </td>
                            </tr>
                            </tbody>
                        </table>
