...
public class DayNameDao {
    ...
    public DayName createDayName(DayName dayName) {
    ...
    public DayName readDayName(Integer dayNameId) {
    ...
    public void updateDayName(DayName dayName) {
        try (Connection connection = DbUtil.getConnection();
    ...
    public void deleteDayName(Integer dayNameId) {
        try (Connection connection = DbUtil.getConnection();
